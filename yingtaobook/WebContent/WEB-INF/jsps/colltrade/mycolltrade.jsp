...
<body>
	<div>
		<div style="float:right;">
			<a class="a_tf" href="${path }/Colltrade/toAddColl.do">添加藏书交易</a>
		</div>
		<div class="clear"></div>
		<c:forEach items="${mctList }" var="coll">
			<div class="div_list">
				<a href=""><img src="${path }/${coll.imgsize }"></a><br>
				<a href="" style="text-indent:-18px;align:center;">${coll.bookname }</a>
			</div>
		</c:forEach>
	</div>
